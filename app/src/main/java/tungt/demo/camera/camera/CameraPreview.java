...
//            result = (info.orientation - degrees + 360) % 360;
        ...
        mCamera.setDisplayOrientation(angle); //Set preview orientation of camera preview folow the screen orientation
        mCamera.setParameters(params);        //Set new parameter for camera
    }
